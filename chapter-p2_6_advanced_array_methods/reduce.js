 ...
 * array.reduce(function(accumulator, currentValue, currentIndex, arr), initialValue)
 ...
 Accumulator accumulates the callback's return values; it is the accumulated value previously returned in the
...
vowelCount("lorem ipsum idiota");

function vowelCount(str) {
	var vowels = "aeiou";
	return str.toLowerCase().split('').reduce(function (acc, next, currentIndex) {
